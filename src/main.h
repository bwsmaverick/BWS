...
static const int64_t MAX_MONEY = 90000000 * COIN; // 90 Milliion CAP
inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const unsigned int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC

static const int64_t GetCoinYearReward = 6 * CENT; // 6% per year

inline int64_t FutureDrift(int64_t nTime) { return nTime + 10 * 60; }

inline unsigned int GetTargetSpacing(int nHeight) { return 120; } // Targetted block spacing in seconds. The P2P network should average to it in the long term.
